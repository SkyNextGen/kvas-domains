...
Build time (UTC): 2026-02-15 05:40:55 UTC
...
Notes:
- `valid_domains` = домены из категории после фильтра (full:/domain:/голые домены)
- `extras_added` = домены, которые реально попали в хвост (не пересекаются с itdog)
- `skipped_directives` = include:/regexp:/keyword:/etc (не разворачиваем)

## Warnings
- ✅ Предупреждений нет

## Hashes
- sha256(final): 9119d44f62720e22a6bcac9ec9326b829ca07e6722f8bc31f1c98632822b8e20
